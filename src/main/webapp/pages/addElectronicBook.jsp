...
<br>
<s:form action="/store/addElectronicBook" method="post" modelAttribute="newElectronicBook">
    ...
    <br>
    <p>Enter text format:</p>
    <s:input path="textFormat" size="30" placeholder="Text format"/>
    <br>
    <s:errors path="textFormat"/>
    <br>
